...
/**
 * This class allows the driver to drive the robot through the driver controller.
 * @author Henry
 * @deprecated No longer necessary for the drive program. DriveOp.class provides the framework
 * for the drvie program
 */
@TeleOp(name = "Drive Op 1.0", group = "drive")
@Disabled
@Deprecated
public class OldDriveOp extends OpMode {
